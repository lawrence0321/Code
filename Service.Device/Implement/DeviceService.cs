...
namespace Service.Device.Implement
{
    internal class DeviceService : AbstractDisposable, IDeviceService
    {
        ...
        public ActResult<AlarmTypePackage> GetNowAlarmTypePackage()
        {
            ...
            var r5 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.M, 1101, 64));
            var r6 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.M, 1001, 64));
            var r7 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.M, 1201, 64));
            var r8 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.M, 1301, 64));
        ...
        public ActResult<RectifierLogDTO> GetRectifierLog()
        {
            try
            {
                ...
                var r1 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.W, 0, 64));
                ...
                var r2 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.W, 64, 64));
                ...
                var r3 = PLC2SendCommand(new ME_QSeriesCmdBuilder(ME_QSeriesCmdBuilder.Elements.W, 768, 64));
        ...
        public ActResult<List<UnLoadDataLogDTO>> GeBackuptUnLoadDatas()
            => new ActResult<List<UnLoadDataLogDTO>>(new List<UnLoadDataLogDTO>());
    }
